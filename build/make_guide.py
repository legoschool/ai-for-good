...
<article class="page">
<h1>웹앱 사용 안내</h1>
<p class="lead">앱을 처음 여시는 선생님이 이 안내만 보고 수업을 끝까지 이끌 수 있도록 적었습니다.
준비부터 마무리까지, 그리고 잘 안 될 때까지 차례로 담았습니다.</p>

<section class="card">
  <h2>한눈에 : 수업 한 시간의 흐름</h2>
  <div class="scroll"><table>
    <tr><th style="width:120px">언제</th><th style="width:150px">누가</th><th>무엇을 하나요</th></tr>
    <tr><td><b>하루 전</b></td><td>선생님</td>
      <td>앱을 열어 <b>둘러보기</b>로 끝까지 해 봅니다. 기기 수와 인터넷을 확인합니다.</td></tr>
    <tr><td><b>수업 시작 3분</b></td><td>선생님</td>
      <td><b>선생님 화면 → 새 방 만들기</b>를 누르고, 나온 여섯 자리 방 번호를 칠판에 적습니다.</td></tr>
    <tr><td><b>이어서 2분</b></td><td>학생</td>
      <td>같은 주소를 열어 방 번호와 별명을 넣고 <b>입장하기</b>를 누릅니다.</td></tr>
    <tr><td><b>수업 중</b></td><td>학생</td>
      <td>화면에 나오는 순서대로 활동하고, 다 하면 <b>제출하기</b>를 누릅니다.</td></tr>
    <tr><td><b>정리 5분</b></td><td>선생님</td>
      <td><b>결과 크게 띄우기</b>로 학급 결과를 함께 봅니다.</td></tr>
    <tr><td><b>수업 뒤</b></td><td>선생님</td>
      <td><b>방 잠그기</b>를 누릅니다. 기록이 필요하면 <b>CSV 내려받기</b>를 함께 씁니다.</td></tr>
  </table></div>
...
<section class="card">
  ...
  <ol class="steps3">
    ...
    <li><b>끝까지 눌러 봅니다.</b> 학생이 어디에서 멈출지 미리 알 수 있습니다.
      한 차시 앱은 대개 5분에서 8분이면 끝까지 해 볼 수 있습니다.</li>
    <li><b>기기를 헤아려 둡니다.</b> 한 사람에 한 대가 아니어도 됩니다. 모둠에 한 대로도 할 수 있습니다.</li>
    <li><b>주소를 미리 열어 둡니다.</b> 학교 태블릿이라면 즐겨찾기에 넣어 두시면 수업 시간이 절약됩니다.</li>
  </ol>
</section>
...
<section class="card">
  ...
  <ol class="steps3">
    ...
    <li>방 번호를 <b>칠판에 크게</b> 적습니다. <b>복사</b>를 눌러 주소를 함께 나눠 주어도 됩니다.</li>
...
<section class="card">
  <h2>3. 수업 중에 선생님 화면에서 하는 일</h2>
  <div class="scroll"><table>
    <tr><th style="width:170px">무엇을 누르나</th><th>하는 일</th><th style="width:190px">언제 쓰나</th></tr>
    <tr><td><b>제출 현황 N명</b></td><td>지금까지 제출한 사람 수를 보여 줍니다</td>
      <td>활동 중에 진행 상황을 볼 때</td></tr>
    <tr><td><b>새로고침</b></td><td>가장 최근 제출까지 다시 불러옵니다</td><td>제출 수가 늘지 않아 보일 때</td></tr>
    <tr><td><b>결과 크게 띄우기</b></td><td>학급 결과를 큰 화면에 띄웁니다</td>
      <td>정리 단계에서 다 함께 볼 때</td></tr>
    <tr><td><b>한 명씩 보기</b></td><td>누가 무엇을 냈는지 표로 봅니다</td>
      <td>개별 지도가 필요할 때만</td></tr>
    <tr><td><b>CSV 내려받기</b></td><td>제출 내용을 파일로 내려받습니다</td><td>수업 뒤 기록으로 남길 때</td></tr>
    <tr><td><b>방 잠그기</b></td><td>더 이상 새 제출을 받지 않습니다</td><td>수업이 끝났을 때</td></tr>
  </table></div>
  <p class="muted">선생님 화면은 다시 열 수 있습니다. <b>선생님 화면 → 기존 방 열기</b>에 방 번호를 넣으면 됩니다.</p>
</section>

<section class="card">
  <h2>4. 학생 화면은 이렇게 이어집니다</h2>
  <ol class="steps3">
  ...
  <p class="muted">화면 맨 위 메뉴는 늘 보입니다. 홈, 둘러보기, 그 차시 페이지, 설문으로 갈 수 있고,
...
<section class="card">
  ...
  <div class="scroll"><table>
    ...
    <tr><td>기기가 모둠당 한 대</td>
      <td>한 명이 조작하고 나머지가 함께 판단합니다. 별명은 모둠 이름으로 씁니다.</td></tr>
    <tr><td>교사 기기 한 대뿐</td>
      <td>화면을 크게 띄워 함께 판단하고, 각자의 기록은 활동지에 손으로 남깁니다.</td></tr>
    <tr><td>인터넷이 끊겼을 때</td>
      <td>활동은 그대로 되고 제출만 되지 않습니다. 인쇄용 활동지로 대신합니다.</td></tr>
    <tr><td>학교망에서 막힐 때</td>
      <td>영상이나 바깥 자료가 열리지 않으면 참고자료에서 다른 자료로 바꿉니다.</td></tr>
  </table></div>
</section>
...
<section class="card">
  ...
  <div class="scroll"><table>
    ...
    <tr><td>학생이 방 번호를 넣어도 들어가지지 않아요</td>
      <td>여섯 자리가 맞는지, 방을 잠그지 않았는지 봅니다. 잠갔으면 새 방을 만듭니다.</td></tr>
    <tr><td>제출했는데 선생님 화면에 보이지 않아요</td>
      <td><b>새로고침</b>을 누릅니다. 학생과 선생님이 같은 방 번호인지 확인합니다.</td></tr>
    <tr><td>학생 화면이 멈춘 것 같아요</td>
      <td>같은 곳을 여러 번 누른 경우가 많습니다. 잠시 기다리면 이어집니다.</td></tr>
    <tr><td>기록을 지우고 다시 하고 싶어요</td>
      <td>맨 위 메뉴의 <b>처음부터</b>를 누릅니다. 그 기기에 저장된 내용만 지워집니다.</td></tr>
    <tr><td>선생님 비밀번호를 잊었어요</td>
      <td>새 방을 만들면 됩니다. 앞 방의 기록은 그대로 남아 있습니다.</td></tr>
    <tr><td>학생이 자기 별명을 잊었어요</td>
