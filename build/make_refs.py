...
<section class="card">
  <h2>먼저 읽을 것</h2>
  <p>자료는 세 가지로 나뉩니다. <b>바탕</b>은 이 수업의 뿌리가 된 곳이고,
  <b>수업 자료</b>는 차시에서 실제로 쓰는 것이며, <b>기준</b>은 판단이 갈릴 때 근거로 삼는 문서입니다.</p>
  <p class="muted">주소는 자주 바뀝니다. 수업 하루 전에 한 번 열어 보시기 바랍니다.</p>
  <div class="note"><b>미리보기 그림에 대하여</b><br>
  각 기관 누리집의 첫 화면을 그대로 담은 것입니다. 저작권은 해당 기관에 있으며,
  수업 자료를 찾아가도록 돕는 <b>교육 목적</b>으로만 싣습니다.
  그림마다 출처를 적었고, 누르면 원래 누리집으로 이동합니다.
...
<section class="card">
  ...
  <p class="muted">차시 페이지와 웹앱 사용 안내에도 그 차시에 쓰는 자료만 골라 실어 두었습니다.</p>
</section>
